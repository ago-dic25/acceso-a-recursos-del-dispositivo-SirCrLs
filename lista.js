...
export default function lista() {
  ...
  const [mensaje, setMensaje] = useState < CameraType > "back";
  ...
  return (
    <View style={styles.container}>
      ...
      ></TextInput>
      <button title="Mostrar mensaje" onClick={contar}>
        mensaje
      </button>
      <button title="limpiar" onClick={() => setContador((nombre = ""))}>
        limpiar nombre
      </button>
      ...
      <button title="aumentar" onClick={() => setContador(contador + 1)}>
        Aumentar
      </button>
